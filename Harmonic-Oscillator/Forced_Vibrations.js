...
function animate() {
    ...
    if (delta_2 > interval_2) {
        ...
        ctx.lineTo(105 +r_forced[x], 135);
        for (let i = 1; i < 11; i++) {
            ctx.lineTo(105 + 5 * i + (+r_forced[x]+1+i), 125 + 10 * Math.pow(-1, i))
        }
        ctx.lineTo(160+r_forced[x], 125);
        ctx.lineTo(190+r_forced[x], 125);
        ctx.stroke();
        /* Draw the mass */
        ctx.beginPath();
        ctx.moveTo(190+r_forced[x], 100);
        ctx.lineTo(240+r_forced[x], 100);
        ctx.lineTo(240+r_forced[x], 150);
        ctx.lineTo(190+r_forced[x], 150);
        ctx.lineTo(190+r_forced[x], 100);
        ctx.fillStyle = "rgba(166,166,166,0.4)";
        ctx.fill();
        ctx.stroke();
